...
func main() {
	...
	paths := combineCRDPaths(
		...
		getCRDPaths(namespaceTemplate, CRD{
			...
			Ref:     "#/definitions/kpack.build.v1alpha1.CustomBuilder",
			ListRef: "#/definitions/kpack.build.v1alpha1.CustomBuilderList",
		}),
		getCRDPaths(clusterTemplate, CRD{
			Group:   "kpack.io",
			Version: "v1alpha1",
			...
			Ref:     "#/definitions/kpack.build.v1alpha1.CustomClusterBuilder",
			ListRef: "#/definitions/kpack.build.v1alpha1.CustomClusterBuilderList",
		}),
		getCRDPaths(clusterTemplate, CRD{
			Group:   "kpack.io",
			Version: "v1alpha1",
			...
			Ref:     "#/definitions/kpack.build.v1alpha1.Stack",
