...
func (c *Reconciler) reconcileBuild(image *v1alpha2.Image, latestBuild *v1alpha2.Build, sourceResolver *v1alpha2.SourceResolver, builder v1alpha2.BuilderResource, buildCacheName string) (v1alpha2.ImageStatus, error) {
...
func noScheduledBuild(buildNeeded corev1.ConditionStatus, builder v1alpha2.BuilderResource, build *v1alpha2.Build) corev1alpha1.Conditions {
...
func builderCondition(builder v1alpha2.BuilderResource) corev1alpha1.Condition {
	if !builder.Ready() {
