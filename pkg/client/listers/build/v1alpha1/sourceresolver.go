...
type SourceResolverLister interface {
	...
	List(selector labels.Selector) (ret []*buildv1alpha1.SourceResolver, err error)
...
type sourceResolverLister struct {
	listers.ResourceIndexer[*buildv1alpha1.SourceResolver]
}
...
func NewSourceResolverLister(indexer cache.Indexer) SourceResolverLister {
	return &sourceResolverLister{listers.New[*buildv1alpha1.SourceResolver](indexer, buildv1alpha1.Resource("sourceresolver"))}
}

// SourceResolvers returns an object that can list and get SourceResolvers.
func (s *sourceResolverLister) SourceResolvers(namespace string) SourceResolverNamespaceLister {
	return sourceResolverNamespaceLister{listers.NewNamespaced[*buildv1alpha1.SourceResolver](s.ResourceIndexer, namespace)}
}
...
type SourceResolverNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*buildv1alpha1.SourceResolver, error)
