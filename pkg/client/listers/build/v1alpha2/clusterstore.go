...
func NewClusterStoreLister(indexer cache.Indexer) ClusterStoreLister {
	return &clusterStoreLister{listers.New[*buildv1alpha2.ClusterStore](indexer, buildv1alpha2.Resource("clusterstore"))}
}
