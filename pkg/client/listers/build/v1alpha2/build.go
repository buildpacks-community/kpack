...
type BuildLister interface {
	...
	List(selector labels.Selector) (ret []*buildv1alpha2.Build, err error)
...
type buildLister struct {
	listers.ResourceIndexer[*buildv1alpha2.Build]
}

// NewBuildLister returns a new BuildLister.
func NewBuildLister(indexer cache.Indexer) BuildLister {
	return &buildLister{listers.New[*buildv1alpha2.Build](indexer, buildv1alpha2.Resource("build"))}
}

// Builds returns an object that can list and get Builds.
func (s *buildLister) Builds(namespace string) BuildNamespaceLister {
	return buildNamespaceLister{listers.NewNamespaced[*buildv1alpha2.Build](s.ResourceIndexer, namespace)}
}
...
type BuildNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*buildv1alpha2.Build, error)
