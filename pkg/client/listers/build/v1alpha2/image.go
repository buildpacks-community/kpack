...
type ImageLister interface {
	...
	List(selector labels.Selector) (ret []*buildv1alpha2.Image, err error)
...
type imageLister struct {
	listers.ResourceIndexer[*buildv1alpha2.Image]
}

// NewImageLister returns a new ImageLister.
func NewImageLister(indexer cache.Indexer) ImageLister {
	return &imageLister{listers.New[*buildv1alpha2.Image](indexer, buildv1alpha2.Resource("image"))}
}

// Images returns an object that can list and get Images.
func (s *imageLister) Images(namespace string) ImageNamespaceLister {
	return imageNamespaceLister{listers.NewNamespaced[*buildv1alpha2.Image](s.ResourceIndexer, namespace)}
}
...
type ImageNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*buildv1alpha2.Image, error)
