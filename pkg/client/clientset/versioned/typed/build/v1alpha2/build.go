...
type BuildInterface interface {
	Create(ctx context.Context, build *v1alpha2.Build, opts v1.CreateOptions) (*v1alpha2.Build, error)
	Update(ctx context.Context, build *v1alpha2.Build, opts v1.UpdateOptions) (*v1alpha2.Build, error)
	UpdateStatus(ctx context.Context, build *v1alpha2.Build, opts v1.UpdateOptions) (*v1alpha2.Build, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha2.Build, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha2.BuildList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.Build, err error)
	BuildExpansion
}
...
func (c *builds) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.Build, err error) {
	result = &v1alpha2.Build{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("builds").
		Name(name).
...
func (c *builds) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.BuildList, err error) {
...
func (c *builds) Create(ctx context.Context, build *v1alpha2.Build, opts v1.CreateOptions) (result *v1alpha2.Build, err error) {
	result = &v1alpha2.Build{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("builds").
...
func (c *builds) Update(ctx context.Context, build *v1alpha2.Build, opts v1.UpdateOptions) (result *v1alpha2.Build, err error) {
	result = &v1alpha2.Build{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("builds").
...
func (c *builds) UpdateStatus(ctx context.Context, build *v1alpha2.Build, opts v1.UpdateOptions) (result *v1alpha2.Build, err error) {
	result = &v1alpha2.Build{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("builds").
...
func (c *builds) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.Build, err error) {
	result = &v1alpha2.Build{}
