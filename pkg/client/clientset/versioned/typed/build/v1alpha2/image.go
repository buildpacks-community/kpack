...
type ImageInterface interface {
	Create(ctx context.Context, image *v1alpha2.Image, opts v1.CreateOptions) (*v1alpha2.Image, error)
	Update(ctx context.Context, image *v1alpha2.Image, opts v1.UpdateOptions) (*v1alpha2.Image, error)
	UpdateStatus(ctx context.Context, image *v1alpha2.Image, opts v1.UpdateOptions) (*v1alpha2.Image, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha2.Image, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha2.ImageList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.Image, err error)
	ImageExpansion
}
...
func (c *images) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.Image, err error) {
	result = &v1alpha2.Image{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("images").
		Name(name).
...
func (c *images) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.ImageList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha2.ImageList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("images").
...
func (c *images) Create(ctx context.Context, image *v1alpha2.Image, opts v1.CreateOptions) (result *v1alpha2.Image, err error) {
	result = &v1alpha2.Image{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("images").
...
func (c *images) Update(ctx context.Context, image *v1alpha2.Image, opts v1.UpdateOptions) (result *v1alpha2.Image, err error) {
	result = &v1alpha2.Image{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("images").
...
func (c *images) UpdateStatus(ctx context.Context, image *v1alpha2.Image, opts v1.UpdateOptions) (result *v1alpha2.Image, err error) {
	result = &v1alpha2.Image{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("images").
...
func (c *images) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.Image, err error) {
	result = &v1alpha2.Image{}
