...
var clusterbuildersResource = v1alpha1.SchemeGroupVersion.WithResource("clusterbuilders")

var clusterbuildersKind = v1alpha1.SchemeGroupVersion.WithKind("ClusterBuilder")
