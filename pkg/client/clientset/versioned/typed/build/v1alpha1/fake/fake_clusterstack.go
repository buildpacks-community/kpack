...
var clusterstacksResource = v1alpha1.SchemeGroupVersion.WithResource("clusterstacks")

var clusterstacksKind = v1alpha1.SchemeGroupVersion.WithKind("ClusterStack")
