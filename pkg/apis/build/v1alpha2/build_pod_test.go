...
func testBuildPod(t *testing.T, when spec.G, it spec.S) {
	...
	buildContext := buildapi.BuildContext{
		BuildPodBuilderConfig: buildapi.BuildPodBuilderConfig{
			...
			Uid:          2000,
			Gid:          3000,
			PlatformAPIs: []string{"0.7", "0.8", "0.9", "0.10", "0.11"},
			OS:           "linux",
		},
		Secrets:  secrets,
	...
	when("BuildPod", func() {
		...
		it("configures detect step", func() {
			...
			assert.Contains(t, pod.Spec.InitContainers[2].Env, corev1.EnvVar{Name: "CNB_PLATFORM_API", Value: "0.11"})
		...
		it("configures analyze step", func() {
			...
			assert.Contains(t, pod.Spec.InitContainers[1].Env, corev1.EnvVar{Name: "CNB_PLATFORM_API", Value: "0.11"})
		...
		it("configures restore step", func() {
			...
			assert.Contains(t, pod.Spec.InitContainers[3].Env, corev1.EnvVar{Name: "CNB_PLATFORM_API", Value: "0.11"})
		...
		it("configures build step", func() {
			...
			assert.Contains(t, pod.Spec.InitContainers[4].Env, corev1.EnvVar{Name: "CNB_PLATFORM_API", Value: "0.11"})
		...
		it("configures export step", func() {
			...
			assert.Contains(t, pod.Spec.InitContainers[5].Env, corev1.EnvVar{Name: "CNB_PLATFORM_API", Value: "0.11"})
