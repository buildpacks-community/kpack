...
func (im *Image) Build(sourceResolver *v1alpha1.SourceResolver, builder v1alpha1.BuilderResource, latestBuild *Build, reasons []string, nextBuildNumber int64) *Build {
...
func (im *Image) SourceResolver() *v1alpha1.SourceResolver {
