...
const (
	...
	BuildpackMetadataEnvVar       = "COMPLETION_BUILDPACK_METADATA"
	CompletionStackIDEnvVar       = "COMPLETION_STACK_ID"
	CompletionStackRunImageEnvVar = "COMPLETION_STACK_RUN_IMAGE"
...
var (
	...
	buildMetadataMount = corev1.VolumeMount{
		Name:      layersVolumeName,
		...
		Spec: corev1.PodSpec{
			...
			Containers: []corev1.Container{
				b.complationContainer(
					...
					[]corev1.EnvVar{
						{
							Name:  BuildpackMetadataEnvVar,
							Value: b.Annotations[BuildLatestBPMetadataAnnotation],
						},
					},
					volumeMounts(
						secretVolumeMounts,
...
func (b *Build) complationContainer(images BuildPodImages, buildContext BuildContext, args []string, env []corev1.EnvVar, volumeMounts []corev1.VolumeMount) corev1.Container {
	return corev1.Container{
		...
		Env: append(env,
			corev1.EnvVar{
				Name:  CompletionStackIDEnvVar,
				Value: buildContext.BuildPodBuilderConfig.StackID,
			},
			corev1.EnvVar{
				Name:  CompletionStackRunImageEnvVar,
				Value: buildContext.BuildPodBuilderConfig.RunImage,
			},
		),
		Args:                     args,
