...
const (
	...
	completionTerminationMessagePathLinux   = "/tmp/completion-termination-path"
...
func terminationMessagePath(os string) string {
	switch os {
	case "windows":
				...
				step(
					corev1.Container{
						...
						Env: []corev1.EnvVar{
							...
							{Name: TerminationMessagePathEnvVar, Value: terminationMessagePath(buildContext.os())},
						},
						Args: args(
							b.notaryArgs(),
							secretArgs,
						...
						TerminationMessagePath:   terminationMessagePath(buildContext.os()),
