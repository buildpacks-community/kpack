...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UserAndGroup) DeepCopyInto(out *UserAndGroup) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UserAndGroup.
func (in *UserAndGroup) DeepCopy() *UserAndGroup {
	if in == nil {
		return nil
	}
	out := new(UserAndGroup)
	in.DeepCopyInto(out)
	return out
}
